...
- 안타깝게도 간편하게 성장할 수 있는 방법은 제시하지 않습니다. 따라서 쉽게 취업하기 위한 방법으로 본 멘토링을 택하시는 것은 큰 도움이 되지 않을 수 있습니다.`,
	...
	'13': {
		mentorName: '김은수', 'title': '4년차 웹 프론트엔드 개발자와의 커리어 Talk', 
...
웹 프론트엔드 개발자로 커리어를 준비하고 계시거나, 이미 현업에서 일하시고 계신 분들과 함께 웹 프론트엔드 개발자의 커리어와 개발 지식, 업무 경험에 대한 얘기를 나누어보려고 합니다. 서로의 커리어적인 고민과 조언을 편하게 나누고 서로의 경험을 바탕으로 지식의 지평을 넓히는 멘토링이 되기를 바랍니다.`, 'howTo': `- 간단한 자기소개
...
- 현업에서 웹 프론트엔드 개발을 하고있으나 다른 분야로의 전환을 고민하고 계신 분`},
	...
	'183': {
		mentorName: '김의진', 
		title: '비전공자에서 토스 프론트엔드 개발자가 되기까지. 학습방법을 많이 고민했고, 가장 효율적인 학습법을 제안해드려요.', 
	...
	짧은 멘토링으로 수백시간을 아껴보세요.`, 'howTo': `- 간단한 본인 소개
	...
	- 기타 진로/개발 관련 고민이 있는 사람`, 
		nonTarget: '- SOPT 웹파트 세미나를 따라가기 어렵다면, 추천하지 않아요. 그것을 일단 열심히 하면 됩니다! 다른 고민이라면 상관없어요.'},
	'534': {	
		mentorName: '김성윤', 
